...
module.exports = {
  async play(song, message) {
    ...
    try {
      ...
      .setTitle("<:multiplemusicalnotes_1f3b6:777415725265846313> Start Playing :")
      .setDescription(`<a:music:777530654610685982> Playing Song: [${song.title}](${song.url})\n<:duration:777531237313150986> Duration: \`[${new Date(song.duration * 1000).toISOString().substr(11, 8)}]\`\n🎋 Request: [<@${message.author.id}>]`)
      .setColor("BLUE")
      .setImage(`https://i.ytimg.com/vi/${song.id}/hqdefault.jpg`)
      .setFooter(song.title)
      .setTimestamp()
      var playingMessage = await queue.textChannel.send(musicembed)
